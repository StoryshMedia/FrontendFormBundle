          ...
          >
            ...
            >
              ...
              >
                <child-item
                  :field="child"
                  :field-index="childIndex"
                  :types="types"
                  :field-config="child.config ?? {}"
                  @updateField="setChildFieldValue($event, childIndex, fieldIndex)"
                  @deleteField="deleteChildField(child, childIndex, fieldIndex)"
                />
              </div>
            </div>
          </div>
...
const ChildItem = defineAsyncComponent(() =>
  import("./ChildItem.vue" /* webpackChunkName: "form-field-child-item" */)
);
